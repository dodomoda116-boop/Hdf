...
async def delete_sapa(client, message):
    ...
    if member.status == ChatMemberStatus.MEMBER:
        bad_words = [
            ...
            "يابن متناكه", "يمتناكه", "يمتناك", "عرث", "الخول", "سكس", "كسي", "كسم توم", "طيز",
            ...
            "كسو", "كسمو", "كسمه", "كساس", "عره", "كس مجلخ", "كلابي", "كسم توم", "بضاني", "تع لحوص",
