...
from VeGa.utils.decorators.admins import ActualAdminCB
from VeGa.utils.decorators.language import language, languageCB
from VeGa.utils.inline.settings import (
    auth_users_markup,
...
@app.on_message(filters.command(["/settings", "الاعدادات"], "") & filters.group & ~BANNED_USERS)
@language
