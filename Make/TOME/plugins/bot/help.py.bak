...
from VeGa.utils.database import get_lang, get_served_users, get_served_chats
from VeGa.utils.decorators.language import LanguageStart, languageCB
from VeGa.utils.inline.help import help_keyboard, help_back_markup, private_help_panel
from VeGa.utils.inline.start import private_panel
from config import BANNED_USERS, HELP_VID_URL, SUPPORT_CHAT
...
@app.on_message(filters.command(["/help","المساعده"], "") & filters.group & ~BANNED_USERS)
@LanguageStart
