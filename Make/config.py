...
API_ID = int(getenv("API_ID", '22796083'))
API_HASH = getenv("API_HASH","751e8fdd1b55d3fbf6f4a8d8f7dda4f4")
BOT_TOKEN = getenv("BOT_TOKEN")




OWNER_ID = int(getenv("OWNER_ID", 7722416548))
OWNER_USERNAME = getenv("OWNER_USERNAME")
BOT_USERNAME = getenv("ID")
BOT_NAME = getenv("BOT_NAME", "˹ᴛᴜɴᴇ ᴠɪᴀ ʙᴏᴛ˼")
ASSUSERNAME = getenv("ASSUSERNAME", "")
EVALOP = list(map(int, getenv("EVALOP", "7722416548").split()))
